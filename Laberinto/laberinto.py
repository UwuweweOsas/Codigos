...
def draw_maze(screen, maze, cell_size, images, show_solution=False):
    ...
    # Dibujar el inicio, la meta y el jugador
...
def main():
    ...
    # Cambiar el texto a 'Fácil' y 'Medio'
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.USEREVENT and event.user_type == pygame_gui.UI_DROP_DOWN_MENU_CHANGED:
                if event.ui_element == solve_selector:
                    ...
                    # Cambiar el laberinto en función de la opción seleccionada
                    if event.text == 'Fácil':
                        maze = Maze('laberinto.txt')
        ...
        # Mostrar la imagen de "imposible" si no hay solución
        ...
        # Mostrar la alerta si el jugador llega a la meta
